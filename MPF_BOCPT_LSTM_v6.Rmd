...
Mean Annual Return: ~9.80%   
Annualized Standard Deviation: ~9.69% (StdDev(monthly return) * sqrt(12))    
Sharpe Ratio (Mean Annual Return): 9.80%/9.69% = 1.0122      
Sortino Ratio: 0.5499 (MAR = 0%)  
Expected Shortfall: 5.73% loss (0% Risk-free rate, 95% C.I.)   
Deflated Sharpe Ratio (p-value): >99.99%     

Monthly installment:   
Total contribution: 337500    
Latest asset value: 935042.2     
Mean annual return: 9.53%   
Internal Rate of Return (IRR): 9.47%       
Annualized Standard Deviation: 9.68%   
Sharpe Ratio: 0.9841   
Sortino Ratio: 0.5574 (MAR = 0%)   
Expected Shortfall: 5.70% loss (0% Risk-free rate, 95% C.I.)   
...
for (row in 1:length(MPF.BOCPT.w[, 1])) {
  ...
  } else if (mean(MPF.BOCPT.stock.return[(row-3):row]) < -0.0035) {
    if (row >= 30) {
      MPF.BOCPT.p[row, ] <- MPF.BOCPT.w[row, ] / MPF.BOCPT.w.sum / 2
      MPF.BOCPT.p[row, 2] <- 0.18
      MPF.BOCPT.p[row, 10] <- 0.32    
    } else {
      MPF.BOCPT.p[row, ] <- MPF.BOCPT.w[row, ] / MPF.BOCPT.w.sum / 2
      MPF.BOCPT.p[row, 10] <- 0.5
    }
