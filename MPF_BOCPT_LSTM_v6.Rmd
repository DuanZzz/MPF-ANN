...
Mean Annual Return: ~9.90%   
Annualized Standard Deviation: ~9.71% (StdDev(monthly return) * sqrt(12))    
Sharpe Ratio (Mean Annual Return): 9.90%/9.71% = 1.0120      
Sortino Ratio: 0.5555 (MAR = 0%)  
Expected Shortfall: 5.73% loss (0% Risk-free rate, 95% C.I.)   
Deflated Sharpe Ratio (p-value): >99.99%     

Monthly installment:   
Total contribution: 337500    
Latest asset value: 948281.3     
Mean annual return: 9.62%   
Internal Rate of Return (IRR): 9.58%       
Annualized Standard Deviation: 9.70%   
Sharpe Ratio: 0.9918   
Sortino Ratio: 0.5629 (MAR = 0%)   
