...
Mean Annual Return: ~10.94%   
Annualized Standard Deviation: ~9.75% (StdDev(monthly return) * sqrt(12))    
Sharpe Ratio (Mean Annual Return): 10.94%/9.75% = 1.122   
Sortino Ratio: 0.7150 (MAR = 0%)  
Expected Shortfall: 5.32% loss (0% Risk-free rate, 95% C.I.)   
