...
Mean Annual Return: ~11.00%   
Annualized Standard Deviation: ~10.82% (StdDev(monthly return) * sqrt(12))   
Sharpe Ratio (Mean Annual Return): 11.18%/10.82% = 1.017   
Sortino Ratio: 0.5390 (MAR = 0%)  
Expected Shortfall: 6.59% loss (0% Risk-free rate, 95% C.I.)   
Deflated Sharpe Ratio (p-value): 99.94%     

Monthly installment:   
Total contribution: 337500    
Latest asset value: 1058005   
Mean annual return: 10.59%   
Annualized Standard Deviation: 10.92%   
Sharpe Ratio: 0.9693   
Sortino Ratio: 0.5216 (MAR = 0%)   
Expected Shortfall: 6.77% loss (0% Risk-free rate, 95% C.I.)   
