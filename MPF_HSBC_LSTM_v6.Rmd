...
Mean Annual Return: ~10.42%   
Annualized Standard Deviation: ~11.99% (StdDev(monthly return) * sqrt(12))   
Sharpe Ratio (Mean Annual Return): 10.42%/11.99% = 0.8693   
Sortino Ratio: 0.4469 (MAR = 0%)  
Expected Shortfall: 7.53% loss (0% Risk-free rate, 95% C.I.)   
Deflated Sharpe Ratio (p-value): 99.93%     

Monthly installment:   
Total contribution: 337500    
Latest asset value: 786425.8   
Mean annual return: 8.50%   
Annualized Standard Deviation: 10.49%   
Sharpe Ratio: 0.8107   
Sortino Ratio: 0.4125 (MAR = 0%)   
Expected Shortfall: 6.78% loss (0% Risk-free rate, 95% C.I.)   
...
charts.PerformanceSummary(portf.rebal.fm, methods= "ModifiedES", geometric=TRUE, p=.95, main="HSBC SuperTrust Plus MPF Scheme Performance")
