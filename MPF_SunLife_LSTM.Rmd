...
Mean Annual Return: ~11.81% (after deducting fees)   
Annualized Standard Deviation: 10.95% (StdDev(monthly return) * sqrt(12))   
Sharpe Ratio (Mean Annual Return): 11.81%/10.95% = 1.079   
Sortino Ratio: 0.4739 (MAR = 0%)  
Expected Shortfall: 6.68% loss (0% Risk-free rate, 95% C.I.)  
