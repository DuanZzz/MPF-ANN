...
Mean Annual Return: ~12.30%   
Annualized Standard Deviation: ~10.10% (StdDev(monthly return) * sqrt(12))    
Sharpe Ratio (Mean Annual Return): 12.30%/10.10% = 1.2180   
Sortino Ratio: 0.7492 (MAR = 0%)  
Expected Shortfall: 5.67% loss (0% Risk-free rate, 95% C.I.)   
Deflated Sharpe Ratio (p-value): >99.999%     

Monthly installment:   
Total contribution: 324000       
Latest asset value: 1190206         
Mean annual return: 12.29%    
Internal Rate of Return (IRR): 12.24%    
Annualized Standard Deviation: 10.08%    
Sharpe Ratio: 1.2203      
Sortino Ratio: 0.7480 (MAR = 0%)   
Expected Shortfall: 5.67% loss (0% Risk-free rate, 95% C.I.)   
...
```{r warning=FALSE, results="hide", eval=FALSE}
use_python("~/tensorflow_v1/bin/python3")
